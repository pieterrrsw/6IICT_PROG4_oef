...
def yolo_verwerking(pad):
    ...
    # Haal alle lagen van het model op
...
def realtime(keuze_camera = 0, keuze_yolo = "normal"):
    ...
    if keuze_yolo == "normal":
        ...
        REGIO_GROOTTE = 412
        ZEKERHEID_THRESHOLD = 0.5
    elif keuze_yolo == "object":
        weights_path, config_path = yolo_pad+"/yolo/yolov3_object.weights", yolo_pad+"/yolo/yolov3_object.cfg"
        REGIO_GROOTTE = 288
        ZEKERHEID_THRESHOLD = 0.5
    else:
        print("Geef 'normal' of 'tiny' op als tweede paramter.")
        return
    ...
    while True:
        ...
        # Verwerk alle zeker gevonden objecten met openCV
        indexen = cv2.dnn.NMSBoxes(kaders_lijst, zekerheden_lijst, 0.5, 0.4)
